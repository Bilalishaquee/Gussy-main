    ...
    <div className="min-h-screen bg-black text-white" >
      ...
      <div className="relative h-[300px] md:h-[400px] flex items-center justify-center text-white px-4">
        <div className="text-center z-10">
          <h1 className="text-4xl md:text-6xl font-serif mb-4">Celebrity Style Spotlight</h1>
          <p className="text-base md:text-lg mb-6">Find and shop the looks of your favorite stars</p>
          <button
